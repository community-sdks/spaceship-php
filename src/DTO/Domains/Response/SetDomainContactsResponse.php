...
final class SetDomainContactsResponse
{
    ...
    public function __construct(
        ...
        public readonly \CommunitySDKs\Spaceship\DTO\Domains\Schema\DomainsPutContactsResponse $data
    ) {}
    ...
    public static function fromPsrResponse(\Psr\Http\Message\ResponseInterface $response): self
    {
        ...
        return new self($response->getStatusCode(), $response->getHeaders(), \CommunitySDKs\Spaceship\DTO\Domains\Schema\DomainsPutContactsResponse::fromArray($decoded));
    }
}
