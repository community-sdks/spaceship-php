...
final class CreateSafePayTransactionResponse
{
    /** @param array<string, list<string>> $headers */
    public function __construct(
        public readonly int $statusCode,
        public readonly array $headers,
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\SafePayTransaction $data
    ) {}
    ...
    public static function fromPsrResponse(\Psr\Http\Message\ResponseInterface $response): self
    {
        ...
        return new self($response->getStatusCode(), $response->getHeaders(), \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\SafePayTransaction::fromArray($decoded));
    }
}
