...
final class ReadAttributeDetailsResponse
{
    ...
    public function __construct(
        ...
        public readonly \CommunitySDKs\Spaceship\DTO\ContactsAttributes\Schema\AttributeDetails $data
    ) {}
    ...
    public static function fromPsrResponse(\Psr\Http\Message\ResponseInterface $response): self
    {
        ...
        return new self($response->getStatusCode(), $response->getHeaders(), \CommunitySDKs\Spaceship\DTO\ContactsAttributes\Schema\AttributeDetails::fromArray($decoded));
    }
}
