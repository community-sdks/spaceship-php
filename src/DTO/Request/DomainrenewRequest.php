...
final class DomainrenewRequest
{
    public function __construct(
        ...
        public readonly \CommunitySDKs\Spaceship\DTO\Schema\DomainsDomainrenewalrequestinfo $body
    ) {
    }
    ...
    public static function sample(): self
    {
        return new self(
            'spaceship.com',
            \CommunitySDKs\Spaceship\DTO\Schema\DomainsDomainrenewalrequestinfo::sample(),
        );
    }
}
