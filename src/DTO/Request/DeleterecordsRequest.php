...
final class DeleterecordsRequest
{
    public function __construct(
        public readonly string $domain,
        public readonly \CommunitySDKs\Spaceship\DTO\Schema\Resourcerecordslistdeleteitem $body
    ) {
    }
    ...
    public static function sample(): self
    {
        return new self(
            'spaceship.com',
            \CommunitySDKs\Spaceship\DTO\Schema\Resourcerecordslistdeleteitem::sample(),
        );
    }
}
