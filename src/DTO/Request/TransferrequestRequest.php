...
final class TransferrequestRequest
{
    public function __construct(
        public readonly string $domain,
        public readonly \CommunitySDKs\Spaceship\DTO\Schema\Domaintransferrequest $body
    ) {
    }
    ...
    public static function sample(): self
    {
        return new self(
            'spaceship.com',
            \CommunitySDKs\Spaceship\DTO\Schema\Domaintransferrequest::sample(),
        );
    }
}
