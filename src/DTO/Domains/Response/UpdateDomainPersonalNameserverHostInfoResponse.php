...
final class UpdateDomainPersonalNameserverHostInfoResponse
{
    ...
    public function __construct(
        ...
        public readonly \CommunitySDKs\Spaceship\DTO\Domains\Schema\PersonalNameserverRecord $data
    ) {}
    ...
    public static function fromPsrResponse(\Psr\Http\Message\ResponseInterface $response): self
    {
        ...
        return new self($response->getStatusCode(), $response->getHeaders(), \CommunitySDKs\Spaceship\DTO\Domains\Schema\PersonalNameserverRecord::fromArray($decoded));
    }
}
