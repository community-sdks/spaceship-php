...
class SellerHubDomainResponse
{
    public function __construct(
        ...
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Enum\SellerHubDomainStatus $status,
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\Price|null $minPrice = null,
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\Price|null $binPrice = null,
        public readonly bool|null $binPriceEnabled = null,
        public readonly bool|null $minPriceEnabled = null
    ) {
    ...
    {
        return new self(
            array_key_exists('name', $data) ? \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\SellerhubDomainName::fromValue($data['name']) : throw new \InvalidArgumentException("Missing required field name for SellerHubDomainResponse"),
            array_key_exists('unicodeName', $data) ? \CommunitySDKs\Spaceship\DTO\Domains\Schema\DomainNameULabel::fromValue($data['unicodeName']) : throw new \InvalidArgumentException("Missing required field unicodeName for SellerHubDomainResponse"),
            ...
            array_key_exists('status', $data) ? \CommunitySDKs\Spaceship\DTO\SellerHub\Enum\SellerHubDomainStatus::fromValue($data['status']) : throw new \InvalidArgumentException("Missing required field status for SellerHubDomainResponse"),
