...
final class CreateSellerHubDomainRequest extends BaseSchema
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            array_key_exists('name', $data) ? ($data['name'] === null ? throw new InvalidArgumentException('Field name cannot be null in CreateSellerHubDomainRequest.') : SellerhubDomainName::fromValue((string) $data['name'])) : throw new InvalidArgumentException('Missing required field name for CreateSellerHubDomainRequest.'),        );
    }
