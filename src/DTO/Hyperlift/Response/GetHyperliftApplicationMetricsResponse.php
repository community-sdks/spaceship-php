...
final class GetHyperliftApplicationMetricsResponse
{
    /** @param array<string, list<string>> $headers */
    public function __construct(
        public readonly int $statusCode,
        public readonly array $headers,
        public readonly \CommunitySDKs\Spaceship\DTO\Hyperlift\Schema\ApplicationMetricsResponse $data
    ) {}
    ...
    public static function fromPsrResponse(\Psr\Http\Message\ResponseInterface $response): self
    {
        ...
        return new self($response->getStatusCode(), $response->getHeaders(), \CommunitySDKs\Spaceship\DTO\Hyperlift\Schema\ApplicationMetricsResponse::fromArray($decoded));
    }
}
