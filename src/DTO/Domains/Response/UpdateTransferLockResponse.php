...
final class UpdateTransferLockResponse
{
    /** @param array<string, list<string>> $headers */
    public function __construct(
        public readonly int $statusCode,
        public readonly array $headers,
        public readonly \CommunitySDKs\Spaceship\DTO\Domains\Schema\DomainsDomainTransferLock $data
    ) {}
    ...
    public static function fromPsrResponse(\Psr\Http\Message\ResponseInterface $response): self
    {
        ...
        return new self($response->getStatusCode(), $response->getHeaders(), \CommunitySDKs\Spaceship\DTO\Domains\Schema\DomainsDomainTransferLock::fromArray($decoded));
    }
}
