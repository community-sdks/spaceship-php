...
class RecordsGetResourceRecordsListQueryParams
{
    /**
    ...
    {
        return new self(
            array_key_exists('take', $data) ? $data['take'] : throw new \InvalidArgumentException("Missing required field take for RecordsGetResourceRecordsListQueryParams"),
            array_key_exists('skip', $data) ? $data['skip'] : throw new \InvalidArgumentException("Missing required field skip for RecordsGetResourceRecordsListQueryParams"),
