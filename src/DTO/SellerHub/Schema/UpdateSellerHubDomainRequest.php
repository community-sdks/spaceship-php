...
class UpdateSellerHubDomainRequest
{
    public function __construct(
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\DomainDescription|null $description = null,
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\DisplayName|null $displayName = null,
        public readonly bool|null $binPriceEnabled = null,
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\PriceUpdate|null $binPrice = null,
        public readonly bool|null $minPriceEnabled = null,
        public readonly \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\PriceUpdate|null $minPrice = null
    ) {
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            array_key_exists('binPrice', $data) ? ($data['binPrice'] === null ? null : \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\PriceUpdate::fromArray($data['binPrice'])) : null,
            array_key_exists('minPriceEnabled', $data) ? ($data['minPriceEnabled'] === null ? null : $data['minPriceEnabled']) : null,
            array_key_exists('minPrice', $data) ? ($data['minPrice'] === null ? null : \CommunitySDKs\Spaceship\DTO\SellerHub\Schema\PriceUpdate::fromArray($data['minPrice'])) : null
        );
    }
